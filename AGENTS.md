...
2. `skill/SKILL.md` — full workflow, 6 designs, 5 themes, 3 motions, 12 templates.
...
- `deck.json` fields: `title`, `footer`, `output`, `design` (default|editorial|brutalist|geometric|architectural|ribbon), `theme` (navy|paper|botanical|swiss|neon), `motion` (corporate|cinematic|playful).
